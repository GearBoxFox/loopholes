...
@export var smoothing_iterations := 0
@export var smoothing_ratio := 0.25
@export	var alignment := "View"
@export var axe := "Y"
@export var show_wireframe := false
@export var wireframe_color := Color(1, 1, 1, 1)
@export var wire_line_width := 1.0
